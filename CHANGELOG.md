...
-   `ts-node-maintained` updated from `v9.1.1` to `v10.3.1`
...
-   [`devDependency`] Update `@types/node`, `eslint`, `eslint-config-airbnb-base`, `tap`, `ts-node-maintained`, & `typescript`
...
-   Add `ts-node-maintained/register` as a default extension (Fixes #182)
